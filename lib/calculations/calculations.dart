...
class MyCalculation 
{
  List<Bloc> subjectList=new List<Bloc>();
  double percentage;
  int totalNumbers;
  int obtainNumbers;
  double creditHours;
  ...
  Stream<bool> get marksListValidation=>Observable
  .combineLatest(_getMarksValidationList(),(value)=> (value.isNotEmpty)?true:false);
  ...
  void calculateSumPer()
  {
    ...
    {
      totalNumbers+=index.totalMarksValue;
      obtainNumbers+=index.obtainMarksValue;
    }
  ...
  void calculateGpa()
  {
    qualityPoints=0;
    creditHours=0; 
    List<double> qp=new List<double>(numberOfSubjects);
    List<double> ch=new List<double>(numberOfSubjects);
    for(int i=0;i<numberOfSubjects;i++) 
    {
      if (subjectList[i].totalMarksValue == 100) 
      {
        ...
        { qp[i] = 20;} else {
          ...
          {
            case 79:  qp[i] = 19.50;  break;
            case 78:  qp[i] = 19.50;  break;
            case 77:  qp[i] = 19.00;  break;
            case 76:  qp[i] = 18.50;  break;
            case 75:  qp[i] = 18.50;  break;
            case 74:  qp[i] = 18.00;  break;
            case 73:  qp[i] = 17.50;  break;
            case 72:  qp[i] = 17.50;  break;
            case 71:  qp[i] = 17.00;  break;
            case 70:  qp[i] = 16.50;  break;
            case 69:  qp[i] = 16.50; break;
            case 68:  qp[i] = 16.00; break;
            case 67:  qp[i] = 15.50; break;
            case 66:  qp[i] = 15.50; break;
            case 65:  qp[i] = 15.00;
                            break;
                        case 64:
                            qp[i] = 14.50;
